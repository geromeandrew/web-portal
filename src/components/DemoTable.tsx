...
export default function DemoTable({ headers, rows, ariaLabel, caption, actions, actionWidth = 76, columnWidths = {}, wrapColumns = [], emptyMessage = "No data available in table", pageSize = 25, groupBy }: DemoTableProps) {
