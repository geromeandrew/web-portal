...
const dashboardUi = {
  ...
  heading:
    "font-elliot text-[24px] font-bold leading-8 tracking-[-0.025em] text-[#0e1522]",
...
export default function DashboardRoute() {
  ...
  return (
    <div className={dashboardUi.page}>
      ...
      <section
        className={dashboardUi.content}
        aria-labelledby="dashboard-greeting"
      >
        <h1 id="dashboard-greeting" className={dashboardUi.heading}>
          Hello, {getUserFirstName(user?.displayName, user?.email)}!
        </h1>
        <p className={dashboardUi.description}>
          Select an authorized pipeline workspace below to upload files or
          manage executions
        </p>
